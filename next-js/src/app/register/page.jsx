      ...
      <div className=" w-full flex flex-col justify-center items-center mt-8">
        ...
        <div className=" w-[420px]  flex flex-col justify-center items-center">
          <form
            ...
            className=" w-[380px] h-[380px] bg-white flex flex-col justify-center  items-center rounded-md"
          >
            {error && (
            ...
            <div className=" flex flex-col mt-4 w-[300px] h-[300px]  items-center">
              <input
                ...
                className=" rounded-md px-2 h-[30px] w-[260px] m-3 bg-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
              <input
              ...
              <button
                type="submit"
                className=" w-[80px] h-[30px] bg-red-300 mt-3"
              >
                sign up
              </button>
            </div>
          ...
          <h3 className=" text-center">
            Already have an accout ? go to{" "}
            <Link href={ROUTES.LOGIN} className=" text-red-700">
              Login
            </Link>
          </h3>
        </div>
